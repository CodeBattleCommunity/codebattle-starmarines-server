...
<ul>
    ...
    <i>При этом, в галактике могут происходить катаклизмы и планетарные катастрофы, которые способны нанести урон боевым дронам, сократив их количество <a href="#disasters">по правилам возникновения катастроф</a></i>
...
<ul>
  <li>тип METEOR: в любую планету, с вероятностью ${disasterSettings.localDisasterFactor * 100}% на игровой тик, может врезаться метеор, уничтожив ${disasterSettings.localDisasterDamage * 100}% находящихся на ней дронов</li>
  <li>тип BLACK_HOLE: между любых планет, с вероятностью ${disasterSettings.interPlanetDisasterFactor * 100}% на игровой тик, может возникнуть черная дыра, уничтожив ${disasterSettings.interPlanetDisasterDamage * 100}% перемещающихся между этими планетами дронов</li>
</ul>
