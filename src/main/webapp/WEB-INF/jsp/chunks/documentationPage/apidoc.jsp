...
<p>Кроме катаклизмов, в галактике периодически могут открываться червоточины между рандомными планетами, через которые можно отправить своих дронов на планету противника. <br/>
  Портал может открыться в любом гровом тике с вероятностью ${portalSettings.portalFactor * 100}% от количества связей между планет, и оставаться открытым в течение ${portalSettings.portalTtl} тиков.
